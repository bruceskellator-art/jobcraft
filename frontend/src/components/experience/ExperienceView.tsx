...
export function ExperienceView() {
  ...
  function handleReorder(kind: ExperienceKind, newKindItems: ExperienceItem[]) {
    const previousItems = items
    setItems(prev => [...prev.filter(i => i.kind !== kind), ...newKindItems])
    reorderExperience(kind, newKindItems.map(i => i.id)).catch(() => {
